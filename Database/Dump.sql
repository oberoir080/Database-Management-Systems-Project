CREATE DATABASE  IF NOT EXISTS `badibasket` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `badibasket`;
-- MySQL dump 10.13  Distrib 8.0.32, for Win64 (x86_64)
--
-- Host: localhost    Database: badibasket
-- ------------------------------------------------------
...
CREATE TABLE `customer` (
  ...
  `delivery_partner_contact_info` int NOT NULL,
...
CREATE TABLE `delivery_partner` (
  ...
  `customer_contact_info` int NOT NULL,
...
CREATE TABLE `employee` (
  ...
  PRIMARY KEY (`id`),
  KEY `aisle_number` (`aisle_number`),
  KEY `product_id` (`product_id`),
  CONSTRAINT `employee_ibfk_1` FOREIGN KEY (`aisle_number`) REFERENCES `product` (`id`),
  CONSTRAINT `employee_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order` (
  ...
  `products_on_discount` varchar(1000) NOT NULL,
...
-- Dump completed on 2023-02-10 15:12:27
